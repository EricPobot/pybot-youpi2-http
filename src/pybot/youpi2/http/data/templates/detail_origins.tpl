...
<p>Youpi est un bras robot doté de cinq degrés de liberté, commercialisé dans les années 80 par JD Productique, à
    destination de l'enseignement en technologie et en automatique.</p>

<p>Il a connu un succès certain dans les collèges et les lycées techniques, à une époque où l'informatique et la
    robotique étaient des matières en vogue en France, notamment à travers le fameux plan <i>Informatique Pour Tous</i>.
</p>

<p>A l'origine, Youpi était souvent connecté à un micro-ordinateur de la marque Thomson, les modèles les plus répandus
    étant le MO5 et le TO7/70 qui furent largement distribués dans les écoles via le plan IPT. Malheureusement, le
    matériel informatique de l'époque est rapidement devenu obsolète et les déboires de Thomson Micro-Informatique ont
    laissé de nombreux enseignants sur le carreau, sans possibilité d'évolution ou même de support technique. </p>

<p>L'informatique à l'école fut un temps enterrée. Parallèlement, Youpi continuait vaille que vaille son chemin, passant
    de main en main, si bien que, hors des réseaux professionnels, on en perdit plus ou moins la trace. Dans les écoles,
    le MO5 vieillissant qui le pilotait tombait en panne; on se disait que c'était bien dommage de jeter un si joli
...
<div class="row">
    <div class="col-xs-6 col-md-8">
        <p>Nous avons pris une approche radicalement différente, en cherchant à utiliser la mécanique de Youpi
            directement avec les ressources technologies actuelles, telles que les cartes Arduino, Raspberry Pi,...</p>
    ...
    <div class="col-xs-6 col-md-4">
        <a href="/static/img/youpinitel-2015.jpg" class="thumbnail">
            <img src="/static/img/youpinitel-2015.jpg" alt="YouPinitel 2015" title="Démonstration 2015">
        </a>
    </div>
</div>
...
<p>Cette réalisation utilisait Youpi <i>"dans son jus"</i>, c'est à dire totalement d'origine. Le pilotage
    ...
    Videotex développé pour s'exécuter sur une carte Raspberry Pi.</p>
